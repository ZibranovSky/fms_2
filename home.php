...
<div class="containe-fluid">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card col-md-4 offset-2 bg-info float-left" style="background-color:#74a381!important;">
			...
			<div class="card col-md-4 offset-2 bg-primary ml-4 float-left" style="background-color:#5098e5!important;">
				<div class="card-body text-white">
					<h4><b>Files</b></h4>
					<hr>

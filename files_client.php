...
<div class="container-fluid">
	<div class="col-lg-12">
			...
			<div class="card col-lg-12" style="background-color:#e1e1e1;">
				...
				<?php 
					...
					while($id > 0){
						...
						echo '<script>
							$("#paths").prepend("<a href=\"client.php?page=files&fid='.$path['id'].'\">'.$path['name'].'</a>/")
						</script>';
						$id = $path['parent_id'];
					}
						echo '<script>
							$("#paths").prepend("<a href=\"client.php?page=files\">..</a>/")
						</script>';
				?>
		...
		<div class="row">
			...
			?>
				<div class="card col-md-2 mt-2 ml-2 mr-2 mb-2 folder-item" data-id="<?php echo $row['id'] ?>" style="background-color:#e9e9e9;" >
					<div class="card-body">
		...
		<hr>
		<div class="row">
			<div class="card col-md-12" style="background-color:#f0f0f0;border:0px;">
				<div class="card-body">

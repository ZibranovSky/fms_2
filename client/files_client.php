						...
						<table class="" width="100%">
							...
							?>
								<tr class='file-item' style="border-bottom:none;" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $name ?>">
									<td class="td" style="border-bottom:none;" ondblclick="preview()">
										<large>
											<span class="mr-3"><i class="fa <?php echo $icon ?>"></i></span>
											<a href="file_details.php?id=<?=$row['id'];?>" style="color: black;" target="_BLANK"><h7 class="to_file"> <?php echo $name ?></h7></a>
										</large>
										<input type="text" class="rename_file" value="<?php echo $row['name'] ?>" data-id="<?php echo $row['id'] ?>" data-type="<?php echo $row['file_type'] ?>" style="display: none">
									</td>
									<!-- <td><i class="to_file"><?php echo date('Y/m/d h:i A',strtotime($row['date_updated'])) ?></i></td> -->
									<!-- <td class="td"><i class="to_file"><?php echo $row['description'] ?></i></td>
									<td class="td"></td> -->
								</tr>
...
<script>
	...
	function preview(){
		// alert("preview");
		// location.href = 'file_preview.php?page=files&fid='+$(this).attr('data-id')
		var t = $(this).attr('data-id') ?? 0;
		window.open('files_preview.php?page=files&fid='+t, '_blank');
	}

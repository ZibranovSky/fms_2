...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<div style="width:800px"> <strong style="display:block;margin:12px 0 4px"><a href="https://slideplayer.com/slide/14191217/" title="4Shared Clone | File Sharing php Script from PHP Script directory." target="_blank">4Shared Clone | File Sharing php Script from PHP Script directory.</a></strong><iframe src="https://player.slideplayer.com/80/14191217/" width="800" height="649" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC;border-width:1px 1px 0" allowfullscreen></iframe>
			...
			<div class="card col-md-12" style="background-color:#f8f9fa;border:0px;">
				<div class="card-body">
					<table class="" width="100%">
						...
						?>
							<tr class='file-item' style="border-bottom:none;" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $name ?>">
								<td class="td" style="border-bottom:none;">
									<large>
										<span class="mr-3"><i class="fa <?php echo $icon ?>"></i></span>
										<h7 class="to_file"> <?php echo $name ?></h7>
									</large>
